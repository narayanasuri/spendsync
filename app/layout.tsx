  ...
  return (
    ...
    >
      <head>
        ...
        {/* Required for iOS and IPadOS splash screens */}
        <link
        ...
        <link
          rel="apple-touch-startup-image"
          href="public/apple-splash-1640-2360.jpg"
          media="(device-width: 820px) and (device-height: 1180px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)"
        />
        <link
          rel="apple-touch-startup-image"
          href="public/apple-splash-2360-1640.jpg"
